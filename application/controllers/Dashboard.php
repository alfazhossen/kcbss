...
class Dashboard extends CI_Controller {
	...
	public function todayDeposite()
	{
	  	...
	  	$this->template->load('template', 'dashboard/today_deposite', $data);
	}
	public function monthlyDeposite()
	{
	  	...
	  	$this->template->load('template', 'dashboard/monthly_deposite', $data);
	}
	public function yearlyDeposite()
	{
	  	...
	  	$this->template->load('template', 'dashboard/yearly_deposite', $data);
	}
	public function todayCost()
	{
	  	...
	  	$this->template->load('template', 'dashboard/today_cost', $data);
	}
	public function monthlyCost()
	{
	  	...
	  	$this->template->load('template', 'dashboard/monthly_cost', $data);
	}
	public function yearlyCost()
	{
	  	...
	  	$this->template->load('template', 'dashboard/yearly_cost', $data);
	}
	public function todayExpense()
	{
	  	...
	  	$this->template->load('template', 'dashboard/today_expense', $data);
	}
	public function monthlyExpense()
	{
	  	...
	  	$this->template->load('template', 'dashboard/monthly_expense', $data);
	}
	public function yearlyExpense()
	{
	  	...
	  	$this->template->load('template', 'dashboard/yearly_expense', $data);
	}
