                ...
                <div class="card-body">
                    <?php echo form_open_multipart()?>
                        <div class="form-group">
                            ...
                            <input class="form-control <?= form_error('username') ? 'is-invalid state-invalid' : null ?>" placeholder="Member ID" type="text" name="username" value="<?= $this->input->post('username') ?? $row->username ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control <?= form_error('password') ? 'is-invalid state-invalid' : null ?>" type="text" name="password" value="<?= $this->input->post('username') ?>">
                            <div class="invalid-feedback"><?= form_error('password') ?></div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Confrim Password</label>
                            <input class="form-control <?= form_error('passconf') ? 'is-invalid state-invalid' : null ?>" type="text" name="passconf" value="<?= $this->input->post('username') ?>">
